...
\usepackage[pdftex,	pdfauthor={},
				...
				pdfsubject={Lab for Software Engineering WS15/16}, 
				breaklinks=true, 
				colorlinks=true, 
				linkcolor=black,
				urlcolor=blue,%blue
...
\students{Ifrat Jahan (3098878)\\Jenniffer Maxisch (3106694)\\Georgios Adamos (3093306)\\Thomas Klimek (3067855)\\Melvin van der Linde (3106762)}
\labtime{Do. 12-14}
...
\begin{figure}[H]
	\centering
  	\includegraphics[width=0.9\textwidth]{figures/A1/contextDiagram.pdf}

...
\usepackage[pdftex,	pdfauthor={},
				pdftitle={Online Banking Application},
...
\students{Student 1 (1234567)\\Student 2 (1234567)\\Student 3 (1234567)\\Student 4 (1234567)\\Student 5 (1234567)}
\labtime{Mo. 10-12}
\supervisor{Roman Wirtz}{roman.wirtz@stud.uni-due.de}
%----------------------------------------------------------------------------------
%----------------------------------------------------------------------------------
...
\large{Winter term 2015/2016}\linebreak
\end{flushright}
\end{minipage}
\hspace*{-18mm}
...
\Huge{Online Banking Application}\vspace*{7mm}
...
\begin{figure}[H]
	\centering
  	\includegraphics[width=0.9\textwidth]{figures/A1/contextDiagram}
...
%-------------------------
%-------------------------
Anton & biddable Domain & User of the system & Contextdiagram\\
\hline
%-------------------------
%-------------------------
...
\hline
Stakeholder & biddable Domain & User of the system & contextdiagram\\
\hline
\multicolumn{4}{|l|}{\textbf{T}}\\
\hline
TOS & machine Domain & Software & contextdiagram\\
\hline
\multicolumn{4}{|l|}{\textbf{U}}\\
\hline
User & biddable Domain & User of the system & contextdiagram\\
\hline
